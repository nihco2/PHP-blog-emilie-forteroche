...
class ArticleManager extends AbstractEntityManager 
{
    ...
    {
        $sql = "INSERT INTO article (id_user, title, content, date_creation, date_update, views) VALUES (:id_user, :title, :content, NOW(), NOW(), 0)";
        $this->db->query($sql, [
    ...
    public function setViewsById(int $id, int $views) : void
    {
    ...
    public function getViewsById(int $id) : int
    {
